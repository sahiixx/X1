...
A node agentic system built with react. This description is generated from repository structure; replace it with a purpose statement when convenient.
...
**Signal strength:** agentic density score `194` (references to agent,
...
```
AGENTS.md
AIRLLM_INTEGRATION.md
CLAUDE.md
DEPLOY.md
DEPLOY_FULL.md
_build_aitmpl_pack.py
_restart_backend.sh
_wsl_restart_backend.sh
aitmpl-pack/
index.html
package-lock.json
package.json
