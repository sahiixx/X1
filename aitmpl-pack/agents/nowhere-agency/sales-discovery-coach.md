...
description: |
  Use when coaching or designing elite discovery: question design, current-state mapping, gap quantification, and call structure that surfaces real buying motivation. Asks one more question than everyone else — the one that closes the deal.
