...
description: |
  Use when designing signal-based outbound: multi-channel prospecting sequences, ICP definition, and research-driven personalization (not volume). Turns buying signals into booked meetings before the competition notices.
