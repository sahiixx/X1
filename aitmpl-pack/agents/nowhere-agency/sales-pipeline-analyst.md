...
description: |
  Use when diagnosing pipeline health, deal velocity, forecast accuracy, and data-driven sales coaching. Turns CRM data into pipeline intelligence that surfaces risks before they become missed quarters.
