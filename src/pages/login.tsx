...
export default function Login() {
  usePageTitle('Sign in — NOWHERE.ai');
    ...
    <PageLayout>
      <section className="relative container mx-auto px-4 lg:px-8 py-16 max-w-md">
        ...
        <div className="relative flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Sign in to your NOWHERE.ai dashboard.</p>
        </div>
        ...
        <Card>
          <form className="space-y-5 p-2" onSubmit={onSubmit}>
            ...
            <div className="space-y-1.5">
              ...
              <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="w-full bg-background border border-input rounded-lg focus:border-primary focus:ring-1 focus:ring-primary p-3 text-sm outline-none transition-all" />
            </div>
